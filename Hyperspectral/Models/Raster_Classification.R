...
#resampling 5nm if training data is resampled
...
predictions <- predict(rf_mod, newdata = spectral_data)
...
library(rasterVis)
levelplot(predicted_raster, main = "Predicted Species Map", col.regions = rainbow(10))
