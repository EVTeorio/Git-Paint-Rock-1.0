...
path <- "E:/Git Paint Rock 1.0/Output/Test_Canopy_Rasters_HSI_leafoff"
output_path <- "C:/Users/PaintRock/Documents/Data processing/Hyperspectral/Fusion_HSI_Leafoff.csv"
...
extract_spectral_data <- function(path) {
  ...
  write.csv(final_df, file.path(output_path),
            row.names = FALSE)
